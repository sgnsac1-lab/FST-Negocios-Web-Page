...
const Acreditattions = () => {
    ...
    return(
        <section className=" relative flex flex-col justify-center items-center bg-slate-900 gap-8 pt-5">
            ...
            <h1 className="font-bold text-5xl text-white">Nuestras <span className='text-blue-500'>Acreditaciones</span> Oficiales</h1>
            <p className="w-130 text-center text-slate-400">Respaldo institucional que garantiza la calidad y seguridad de nuestros servicios de consultoria estrategica.</p>
            ...
            <div className="flex justify-center items-center gap-6">
              ...
              <div className="group relative h-full">
                ...
                <div className="relative h-full bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-[2.4rem] p-8 md:p-10 flex flex-col transition-all duration-500 group-hover:translate-y-2">
                    ...
                    {/* Content */}
                    <div className="mb-8">
                    <h4 className="text-blue-400 text-xs font-black uppercase tracking-[0.3em] mb-3">ACREDITACION ADHESION</h4>
                    <h3 className="text-2xl md:text-3xl font-bold text-white leading-tight group-hover:text-blue-300 transition-colors w-100">
                        Centro de Transformacion Digital
                    </h3>
                    <div className="mt-4 w-12 h-1 bg-blue-500 rounded-full transition-all duration-500 group-hover:w-24"></div>
                    </div>

                    <p className="text-slate-400 text-sm mb-10 leading-relaxed italic w-95">
              ...
              <div className="group relative h-full">
                ...
                <div className="relative h-full bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-[2.4rem] p-8 md:p-10 flex flex-col transition-all duration-500 group-hover:translate-y-2">
                    ...
                    {/* Content */}
                    <div className="mb-8">
                    <h4 className="text-blue-400 text-xs font-black uppercase tracking-[0.3em] mb-3">ACREDITACION RED DE ACELERADORAS</h4>
                    <h3 className="text-2xl md:text-3xl font-bold text-white leading-tight group-hover:text-blue-300 transition-colors w-100">
